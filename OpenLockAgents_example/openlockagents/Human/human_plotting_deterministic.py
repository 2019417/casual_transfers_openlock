...
def main():
    ...
    config_data = common.load_human_config_json()
    data_dir = config_data["HUMAN_DETERMINISTIC_DATA_DIR"]
    ...
    outliers_xfer = {'2621512303', '2823189312', '2921021640', '3125513326', '3127842216', '3149972998', '3571817913'}
    outliers_extras = {'2823606819', '1765495362', '2562371801', '2378760540', '2240960040', '3221124899', '3086567642', '2921063409', '3492951018', '3667837660', '1929833271', '3327419966', '2846933910', '2122378021', '2117379298'}
    outliers = outliers.union(outliers_bl)
    outliers = outliers.union(outliers_xfer)
    outliers = outliers.union(outliers_extras)

    convert_to_position = True
    all_subject_data = log_io.load_subjects_from_dir(subject_data_dir, ext="json", convert_to_position=convert_to_position)
