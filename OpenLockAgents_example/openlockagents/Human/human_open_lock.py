...
from openlockagents.common.common import pre_env_instantiation_setup
...
if __name__ == "__main__":
    ...
    params["effect_probabilities"] = generate_effect_probabilities(l1=1, l2=1, l0=1, l3=1)
    ...
    env = pre_env_instantiation_setup(params)
