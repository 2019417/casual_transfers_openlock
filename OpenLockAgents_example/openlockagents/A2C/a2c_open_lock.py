...
from openlockagents.A2C.a2c_agent import A2CAgent
...
def a2c_main_like_human(str_scenario: str, gpuid: int, reward_mode: str='negative_immovable_unique_solutions', num_iter: int=100, attempt_limit: int=700,
         load_path: str=None):
    torch.set_default_tensor_type("torch.DoubleTensor")
    # Set up environment
    params = {
