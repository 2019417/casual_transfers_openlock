...
from openlockagents.A2C.model import DiscretePolicy
from openlockagents.A2C.model import Value
from openlockagents.A2C.core import update_params
from openlockagents.A2C.utils.replay_memory import Memory
...
class A2CAgent(Agent):
    def __init__(self, env, state_size, action_size, params, require_log=True):
        ...
        :param params
        """
        super(A2CAgent, self).__init__("A2C", params, env)
        if require_log:
            super(A2CAgent, self).setup_subject(human=False, project_src=params["src_dir"])
